                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text('Book trusted local professionals', style: AppTypography.bodySmall),
                          ],
                        ),
                      ),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text('Service Provider App', style: AppTypography.titleLarge.copyWith(color: AppColors.textPrimary)),
                            Text('Accept jobs, send quotes & earn', style: AppTypography.bodySmall.copyWith(color: AppColors.textPrimary)),
                          ],
                        ),
                      ),
